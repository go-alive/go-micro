...
// DEPRECATED: this is frozen package, use github.com/go-alive/go-micro/logger
package log
...
import (
	...
	dlog "github.com/go-alive/go-micro/debug/log"
	nlog "github.com/go-alive/go-micro/logger"
)
